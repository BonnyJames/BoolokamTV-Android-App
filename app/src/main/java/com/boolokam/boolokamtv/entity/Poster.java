...
public class Poster implements Parcelable {
    ...
    @SerializedName("viewesCountNbv")
    @Expose
    private Integer viewesCountNbv;
    ...
    public Integer getViewesCountNbv() {
        return viewesCountNbv;
    }

    public void setViewesCountNbv(Integer viewesCountNbv) {
        this.viewesCountNbv = viewesCountNbv;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        if (viewesCountNbv == null) {
            dest.writeByte((byte) 0);
        } else {
            dest.writeByte((byte) 1);
            dest.writeInt(viewesCountNbv);
        }
