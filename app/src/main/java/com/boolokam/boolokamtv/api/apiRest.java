package com.boolokam.boolokamtv.api;
...
import com.boolokam.boolokamtv.entity.Category;
import com.boolokam.boolokamtv.entity.Channel;
import com.boolokam.boolokamtv.entity.Comment;
import com.boolokam.boolokamtv.entity.Country;
...
import com.boolokam.boolokamtv.entity.Plan;
import com.boolokam.boolokamtv.entity.Poster;
import com.boolokam.boolokamtv.entity.Season;
import com.boolokam.boolokamtv.entity.Vote;
...
public interface apiRest {
    ...
    @GET("competition/details/{id}/" + Global.SECURE_KEY)
    Call<Vote> getVoteDetails(@Path("id") Integer id);

    @GET("competition/all/" + Global.SECURE_KEY)
    Call <List<Leaderboard>> getAllVotes();

    @GET("movie/vote/by/{id}/{userID}")
    Call <CastVote> castVote(@Path("id") Integer id, @Path("userID") String userID);

    @GET("movie/CurrentVoteCount/by/{id}")
    Call <VoteCount> getVoteDetailsByMovieID(@Path("id") Integer id);
