package com.boolokam.boolokamtv.config;


public class Global {
    //public static final String API_URL = "http://admin.boolokam.tv/api/";
    public static final String API_URL = "http://bonnyj5.sg-host.com/api/";
