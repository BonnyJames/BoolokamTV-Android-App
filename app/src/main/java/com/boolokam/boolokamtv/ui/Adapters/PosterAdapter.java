...
public class PosterAdapter  extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        switch (getItemViewType(position)) {
            case 1:
                ...
                int maxLength = 12;
                //holder.movieNameTV.setFilters(new InputFilter[] {new InputFilter.LengthFilter(maxLength)});
                holder.movieNameTV.setText(posterList.get(position).getTitle());
    ...
    public class PosterHolder extends RecyclerView.ViewHolder {
        ...
        public PosterHolder(View itemView) {
            ...
            this.movieNameTV = itemView.findViewById(R.id.text_view_movie_name);
        }
    }
    ...
    *//**
     * Populates a {link } object with data from a given
