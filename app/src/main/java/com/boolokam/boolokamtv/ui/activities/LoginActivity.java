...
public class LoginActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener
{
    ...
    //private RelativeLayout relative_layout_fb_login;
    ...
    public void initView(){
        ...
        //this.relative_layout_fb_login = findViewById(R.id.relative_layout_fb_login);
//        this.text_view_login_activity_privacy = (TextView) findViewById(R.id.text_view_login_activity_privacy);
    ...
    public void initAction(){
       /* this.text_view_login_activity_privacy.setOnClickListener(new View.OnClickListener() {
        ...
        this.relative_layout_email_login.setOnClickListener(v -> {
            ...
            text_input_editor_text_activity_login_email.requestFocus();
        });
        relative_layout_confirm_full_name.setOnClickListener(v->{
            ...
            updateToken(Integer.parseInt(id_user),token_user,firebaseToken,edit_text_name_login_acitivty.getText().toString());
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationCompleted(PhoneAuthCredential credential) {
                ...
                VerificationCode = credential.getSmsCode().toString();
            ...
            public void onVerificationFailed(FirebaseException e) {
                ...
                Log.d(Global.TAG, "onVerificationFailed", e);
            ...
            public void onCodeSent(@NonNull String verificationId,
                ...
                Log.d(Global.TAG, "onCodeSent:" + verificationId);
    ...
    /*public void FaceookSignIn(){
        ...
        relative_layout_fb_login.setOnClickListener(new View.OnClickListener() {
            @Override
