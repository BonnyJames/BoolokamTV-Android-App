...
import com.boolokam.boolokamtv.databinding.FragmentPlayerBinding;
...
public class CustomPlayerFragment extends Fragment {
    ...
    public void setSubtitleView() {
        ...
        playerView.getSubtitleView().setStyle(new CaptionStyleCompat(textColor, Color.TRANSPARENT, backrgoundColor, CaptionStyleCompat.EDGE_TYPE_OUTLINE, Color.BLACK, null));
        playerView.getSubtitleView().setFixedTextSize(TypedValue.COMPLEX_UNIT_PT, textSiz);
    ...
    private void initView(FragmentPlayerBinding binding) {
        ...
        /*if(view!=null)
            Toast.makeText(view.getContext(),"View is not Null",Toast.LENGTH_SHORT).show();*/
        ...
        setSubtitleView();
        backImgButton = view.findViewById(R.id.backImgButton);

        playerView.setShutterBackgroundColor(Color.TRANSPARENT);
        if (isLive) {
            if (text_view_exo_player_live != null)
    ...
    private void loadSubtitles() {
        if (videoKind == null)
            return;
        if (text_view_exo_player_loading_subtitles != null)
    ...
    private void initAction() {
        if (this.image_view_exo_player_back != null)
        ...
        if (this.image_view_dialog_source_plus != null)
        ...
        if (this.image_view_exo_player_forward_10 != null)
        ...
        if (this.image_view_exo_player_replay_10 != null)
        ...
        if (this.image_view_exo_player_rotation != null)
        ...
        if (this.image_view_exo_player_subtitles != null)
        ...
        if (this.image_view_dialog_source_close != null)
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mCustomPlayerViewModel.onStart(playerView, getUrlExtra());
        if (!done)
    ...
    public void onCastSessionEndedEvent(CastSessionEndedEvent event) {
        ExoPlayer mExoPlayer = mCustomPlayerViewModel.getExoPlayer();
        PlayerView playerView = mCustomPlayerViewModel.getSimpleExoPlayerView();
        if (mExoPlayer != null) {
