...
import com.boolokam.boolokamtv.ui.Adapters.HomeAdapter;
...
public class HomeFragment extends Fragment {
        ...
        call.enqueue(new Callback<Data>() {
            ...
            public void onResponse(Call<Data> call, Response<Data> response) {
                ...
                if (response.isSuccessful()){
                    /*if(Global.IS_LOGG)
                        Log.d("HOME_DATA","HOME DATA: "+response.body().toString());*/
                    dataList.clear();
   ...
   private void showLoadingView(){
    ...
    private void initViews() {
        ...
        /*if(Global.IS_LOGG)
            Log.d(Global.TAG,"Data list of Home: "+dataList.toString());*/
        ...
        recycler_view_home_fragment.setNestedScrollingEnabled(true);
    }
